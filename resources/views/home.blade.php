                ...
                <div class="row">
                        ...
                        <div class="card bg-c-yellow update-card">
                            ...
                            <div class="card-footer">
                                <p class="text-white m-b-0"><i
                                        class="fa fa-file-pdf text-white f-14 m-r-10"></i>
                                    PDF</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-c-green update-card">
                            ...
                            <div class="card-footer">
                                <p class="text-white m-b-0"><i
                                        class="fa fa-file text-white f-14 m-r-10"></i>Tabloïd</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-c-pink update-card">
                            ...
                            <div class="card-footer">
                                <p class="text-white m-b-0"><i
                                        class="feather icon-clock text-white f-14 m-r-10"></i>Publicités</p>
                            </div>
                        </div>
                    </div>
