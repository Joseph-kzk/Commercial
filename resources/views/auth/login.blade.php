                ...
                <div class="auth-box card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group form-primary">
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Addresse mail" required autocomplete="email" autofocus>
